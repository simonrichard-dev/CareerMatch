...
export default function ChoiceScreen() {
  ...
  function handleContinue() {
    if (choice) {
      axiosPost('/user/choice/', { choice })  // Envoi le choix à la base de données
        .then((response) => {
          console.log(response?.data);
          // Enregistrer le token ou autre logique si nécessaire
          navigation.navigate('ProposalScreen'); // Navigation vers ProposalScreen
        });
    } else {
